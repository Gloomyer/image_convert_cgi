...
#define FILE_PREFIX "/Users/gloomypan/www"

int main(int, char **);

void controller_test_handler(FCGX_Request &);

void controller_ret_image_basic_info(FCGX_Request &, std::string &);

void controller_ret_image_detail_info(FCGX_Request &, std::string &);
